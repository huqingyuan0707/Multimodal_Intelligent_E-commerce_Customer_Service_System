<!-- 职责：VSCode Copilot 下 /impeccable 统一入口，argument-hint 即输即提示 6 子命令 | 链路：Chat 输入框 /impeccable → 本文件 → .github/skills/impeccable/SKILL.md §Commands → reference/<子命令>.md | 对齐：AGENTS.md §2 + SKILL.md §Commands -->
---
name: impeccable
